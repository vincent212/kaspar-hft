...
namespace light::tachbook
{

  struct TachBook : public actors::Actor, public frame::ob::act::OB_Abstract
  {
    ...
    std::vector<cfsmp> hiprio_subs, loprio_subs, aggr_subs, bbbosubs, bbbo_only_subs;
