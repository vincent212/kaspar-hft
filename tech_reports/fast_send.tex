...
throughput \cite{kasparperf}. All figures below were taken on Apple Silicon
...
depth; and they were taken primarily on Apple Silicon. A pinned cross-check on the
x86-64 Linux target (AMD EPYC, \texttt{g++} 15) reproduces the \emph{ratios} ---
