...
runs \textasciitilde100~\textmu s at the median with p99 under a
...
loses about 0.011 ticks per contract per millisecond of delay and aggressive
about 0.042 --- roughly four times as fast --- and the
