...
order individually}. That is what makes a queue position, and therefore a fill
...
millisecond, measured end to end from market data in to order on the wire.
...
Quantity filling on arrival  & \code{1.04\,\%} & \code{51.86\,\%} \\
\bottomrule
\end{tabularx}
