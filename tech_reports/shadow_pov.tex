...
and a lifetime but waits to be reached, and loses $0.011$. A placement rule
coupled to nothing should sit at roughly zero, and establishing that is the
purpose of the null comparison in Section~\ref{sec:future}: the discriminating
statistic is the \emph{slope}, not the level. This argument establishes that the
coupling exists; it does not measure what the coupling is worth against not
having it, which is what the null is for.
