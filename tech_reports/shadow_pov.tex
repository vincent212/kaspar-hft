...
The remaining four tenths of a point do not carry the result. A zero-impact
simulator already rules out cost scaling with volume share, but not cost moving
through selection --- a different placement rate shadows different adds, sitting
in different queues. The sweep shows it does not: across $1.05\,\%$,
$1.90\,\%$, $3.18\,\%$, $4.86\,\%$ and $6.85\,\%$ aggressive participation
the cost runs $+0.0884$, $+0.0726$, $+0.0869$, $+0.0952$ and $+0.0870$ ticks per
contract, every interval overlapping every other.
