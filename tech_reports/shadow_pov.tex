...
its own. Those references fix the \emph{schedule}; what the passive side lacks
is the same kind of fixed reference for \emph{placement}, which is the gap a
model-free placement rule fills. The naive alternatives --- posting
