...
#ifndef _SBE_HALTREASON_H_
#define _SBE_HALTREASON_H_
...
public:
    enum Value
    {
        ...
        TradeDateRoll = static_cast<std::uint8_t>(7),
    ...
    static HaltReason::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(7): return TradeDateRoll;
    ...
    static const char *c_str(const HaltReason::Value value)
    {
        switch (value)
        {
            ...
            case TradeDateRoll: return "TradeDateRoll";
