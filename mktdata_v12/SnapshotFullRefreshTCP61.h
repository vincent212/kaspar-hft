...
#ifndef _SBE_SNAPSHOTFULLREFRESHTCP61_H_
#define _SBE_SNAPSHOTFULLREFRESHTCP61_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(61);
    ...
    {
        return *this = SnapshotFullRefreshTCP61(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    SnapshotFullRefreshTCP61 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefreshTCP61(
            buffer,
    ...
    SnapshotFullRefreshTCP61 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshTCP61(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        SnapshotFullRefreshTCP61 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefreshTCP61 _writer)
{
