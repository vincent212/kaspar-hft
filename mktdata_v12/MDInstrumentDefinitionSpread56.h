...
#ifndef _SBE_MDINSTRUMENTDEFINITIONSPREAD56_H_
#define _SBE_MDINSTRUMENTDEFINITIONSPREAD56_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(255);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(56);
    ...
    MDInstrumentDefinitionSpread56() = default;
    ...
    MDInstrumentDefinitionSpread56(char *buffer, const std::uint64_t bufferLength) :
        MDInstrumentDefinitionSpread56(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDInstrumentDefinitionSpread56(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDInstrumentDefinitionSpread56(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(255);
    }
    ...
    MDInstrumentDefinitionSpread56 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = MDInstrumentDefinitionSpread56(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDInstrumentDefinitionSpread56 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDInstrumentDefinitionSpread56(
            buffer,
    ...
    MDInstrumentDefinitionSpread56 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = MDInstrumentDefinitionSpread56(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDInstrumentDefinitionSpread56 &sbeRewind()
    {
    ...
    {
        MDInstrumentDefinitionSpread56 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securityUpdateAction(const SecurityUpdateAction::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &lastUpdateTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &mDSecurityTradingStatus(const SecurityTradingStatus::Value value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &applID(const std::int16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &marketSegmentID(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &underlyingProduct(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securityExchange(const std::uint64_t index, const char value)
    {
        if (index >= 4)
        {
    ...
    MDInstrumentDefinitionSpread56 &putSecurityExchange(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 19, src, sizeof(char) * 4);
        return *this;
    }

    MDInstrumentDefinitionSpread56 &putSecurityExchange(
        const char value0,
        const char value1,
        const char value2,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putSecurityExchange(const std::string_view str)
    {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putSecurityExchange(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 4)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securityGroup(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionSpread56 &putSecurityGroup(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putSecurityGroup(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putSecurityGroup(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &asset(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionSpread56 &putAsset(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putAsset(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putAsset(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &symbol(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    MDInstrumentDefinitionSpread56 &putSymbol(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putSymbol(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putSymbol(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securityType(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionSpread56 &putSecurityType(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putSecurityType(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putSecurityType(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &cFICode(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionSpread56 &putCFICode(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putCFICode(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putCFICode(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &currency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionSpread56 &putCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 76, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionSpread56 &putCurrency(
        const char value0,
        const char value1,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putCurrency(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &securitySubType(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    MDInstrumentDefinitionSpread56 &putSecuritySubType(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putSecuritySubType(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putSecuritySubType(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &userDefinedInstrument(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &matchAlgorithm(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &minTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &maxTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &priceDisplayFormat(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    SBE_NODISCARD PRICENULL9 &priceRatio()
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &tickRule(const std::int8_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &unitOfMeasure(const std::uint64_t index, const char value)
    {
        if (index >= 30)
        {
    ...
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 30)
        {
    ...
    #else
    MDInstrumentDefinitionSpread56 &putUnitOfMeasure(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 30)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &openInterestQty(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &clearedVolume(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &mainFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &subFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionSpread56 &tradingReferenceDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD char priceQuoteMethod(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 195 + (index * 1), sizeof(char));
        return (val);
    }

    MDInstrumentDefinitionSpread56 &priceQuoteMethod(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 195 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getPriceQuoteMethod(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 195, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 195, src, sizeof(char) * 5);
        return *this;
    }

    SBE_NODISCARD std::string getPriceQuoteMethodAsString() const
    {
        const char *buffer = m_buffer + m_offset + 195;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 195, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 195 + start] = 0;
        }

        return *this;
    }
    #else
    MDInstrumentDefinitionSpread56 &putPriceQuoteMethod(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 195, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 195 + start] = 0;
        }
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD char riskSet(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 200 + (index * 1), sizeof(char));
        return (val);
    }

    MDInstrumentDefinitionSpread56 &riskSet(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 200 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getRiskSet(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 200, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    MDInstrumentDefinitionSpread56 &putRiskSet(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 200, src, sizeof(char) * 6);
        return *this;
    }

    SBE_NODISCARD std::string getRiskSetAsString() const
    {
        const char *buffer = m_buffer + m_offset + 200;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putRiskSet(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
        ...
        std::memcpy(m_buffer + m_offset + 200, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 6; ++start)
        {
            m_buffer[m_offset + 200 + start] = 0;
        }

        return *this;
    }
    #else
    MDInstrumentDefinitionSpread56 &putRiskSet(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
        ...
        std::memcpy(m_buffer + m_offset + 200, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 6; ++start)
        {
            m_buffer[m_offset + 200 + start] = 0;
        }
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD char marketSet(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 206 + (index * 1), sizeof(char));
        return (val);
    }

    MDInstrumentDefinitionSpread56 &marketSet(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 206 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getMarketSet(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 206, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    MDInstrumentDefinitionSpread56 &putMarketSet(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 206, src, sizeof(char) * 6);
        return *this;
    }

    SBE_NODISCARD std::string getMarketSetAsString() const
    {
        const char *buffer = m_buffer + m_offset + 206;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putMarketSet(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
        ...
        std::memcpy(m_buffer + m_offset + 206, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 6; ++start)
        {
            m_buffer[m_offset + 206 + start] = 0;
        }

        return *this;
    }
    #else
    MDInstrumentDefinitionSpread56 &putMarketSet(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
        ...
        std::memcpy(m_buffer + m_offset + 206, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 6; ++start)
        {
            m_buffer[m_offset + 206 + start] = 0;
        }
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD std::uint64_t instrumentGUID() const SBE_NOEXCEPT
    {
        ...
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 212, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    MDInstrumentDefinitionSpread56 &instrumentGUID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 212, &val, sizeof(std::uint64_t));
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD char financialInstrumentFullName(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 220 + (index * 1), sizeof(char));
        return (val);
    }

    MDInstrumentDefinitionSpread56 &financialInstrumentFullName(const std::uint64_t index, const char value)
    {
        if (index >= 35)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 220 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getFinancialInstrumentFullName(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 220, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 220, src, sizeof(char) * 35);
        return *this;
    }

    SBE_NODISCARD std::string getFinancialInstrumentFullNameAsString() const
    {
        const char *buffer = m_buffer + m_offset + 220;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 35)
        {
        ...
        std::memcpy(m_buffer + m_offset + 220, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 35; ++start)
        {
            m_buffer[m_offset + 220 + start] = 0;
        }

        return *this;
    }
    #else
    MDInstrumentDefinitionSpread56 &putFinancialInstrumentFullName(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 35)
        {
        ...
        std::memcpy(m_buffer + m_offset + 220, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 35; ++start)
        {
            m_buffer[m_offset + 220 + start] = 0;
        }
...
public:
            ...
            std::basic_ostream<CharT, Traits> &builder, NoLegs writer)
        {
            ...
            builder << ", ";
            builder << R"("LegPrice": )";
            if (writer.legPriceInActingVersion())
            {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDInstrumentDefinitionSpread56 _writer)
{
    MDInstrumentDefinitionSpread56 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDInstrumentDefinitionSpread56", )";
    ...
    if (writer.priceRatioInActingVersion())
    {
