...
#ifndef _SBE_SNAPSHOTFULLREFRESHLONGQTY69_H_
#define _SBE_SNAPSHOTFULLREFRESHLONGQTY69_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(69);
    ...
    SnapshotFullRefreshLongQty69() = default;
    ...
    SnapshotFullRefreshLongQty69(char *buffer, const std::uint64_t bufferLength) :
        SnapshotFullRefreshLongQty69(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SnapshotFullRefreshLongQty69(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SnapshotFullRefreshLongQty69(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(69);
    }
    ...
    SnapshotFullRefreshLongQty69 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshLongQty69(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    SnapshotFullRefreshLongQty69 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefreshLongQty69(
            buffer,
    ...
    SnapshotFullRefreshLongQty69 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshLongQty69(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    SnapshotFullRefreshLongQty69 &sbeRewind()
    {
    ...
    {
        SnapshotFullRefreshLongQty69 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &lastMsgSeqNumProcessed(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &lastUpdateTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshLongQty69 &mDSecurityTradingStatus(const SecurityTradingStatus::Value value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefreshLongQty69 _writer)
{
    SnapshotFullRefreshLongQty69 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SnapshotFullRefreshLongQty69", )";
