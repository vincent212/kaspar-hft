...
#ifndef _SBE_MDINCREMENTALREFRESHORDERBOOK47_H_
#define _SBE_MDINCREMENTALREFRESHORDERBOOK47_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(47);
    ...
    {
        return *this = MDIncrementalRefreshOrderBook47(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    MDIncrementalRefreshOrderBook47 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshOrderBook47(
            buffer,
    ...
    MDIncrementalRefreshOrderBook47 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshOrderBook47(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshOrderBook47 _writer)
{
