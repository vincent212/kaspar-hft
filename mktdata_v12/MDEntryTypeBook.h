...
#ifndef _SBE_MDENTRYTYPEBOOK_H_
#define _SBE_MDENTRYTYPEBOOK_H_
...
public:
    enum Value
    {
        ...
        MarketBestOffer = static_cast<char>(119),
        MarketBestBid = static_cast<char>(120),
    ...
    static MDEntryTypeBook::Value get(const char value)
    {
        switch (value)
        {
            ...
            case static_cast<char>(119): return MarketBestOffer;
            case static_cast<char>(120): return MarketBestBid;
    ...
    static const char *c_str(const MDEntryTypeBook::Value value)
    {
        switch (value)
        {
            ...
            case MarketBestOffer: return "MarketBestOffer";
            case MarketBestBid: return "MarketBestBid";
