...
#ifndef _SBE_MDINCREMENTALREFRESHLIMITSBANDING50_H_
#define _SBE_MDINCREMENTALREFRESHLIMITSBANDING50_H_
...
public:
    ...
    MDIncrementalRefreshLimitsBanding50() = default;
    ...
    MDIncrementalRefreshLimitsBanding50(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshLimitsBanding50(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshLimitsBanding50(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshLimitsBanding50(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MDIncrementalRefreshLimitsBanding50 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshLimitsBanding50(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshLimitsBanding50 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshLimitsBanding50(
            buffer,
    ...
    MDIncrementalRefreshLimitsBanding50 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshLimitsBanding50(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshLimitsBanding50 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshLimitsBanding50 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshLimitsBanding50 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        static SBE_CONSTEXPR std::int8_t mDUpdateActionNullValue() SBE_NOEXCEPT
        {
            return SBE_NULLVALUE_INT8;
        }

        static SBE_CONSTEXPR std::int8_t mDUpdateActionMinValue() SBE_NOEXCEPT
        {
            return static_cast<std::int8_t>(-127);
        }

        static SBE_CONSTEXPR std::int8_t mDUpdateActionMaxValue() SBE_NOEXCEPT
        {
            return static_cast<std::int8_t>(127);
        }

        static SBE_CONSTEXPR std::size_t mDUpdateActionEncodingLength() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::int8_t mDUpdateAction() SBE_NOEXCEPT
        {
    ...
    #pragma clang diagnostic pop
        ...
        {
            static const std::uint8_t mDEntryTypeValues[] = { 103, 0 };
        ...
        {
            static std::uint8_t mDEntryTypeValues[] = { 103 };
        ...
        {
            static const std::uint8_t MDEntryTypeValues[] = { 103 };
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshLimitsBanding50 _writer)
{
    MDIncrementalRefreshLimitsBanding50 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshLimitsBanding50", )";
