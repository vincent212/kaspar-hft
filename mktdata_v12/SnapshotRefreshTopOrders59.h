...
#ifndef _SBE_SNAPSHOTREFRESHTOPORDERS59_H_
#define _SBE_SNAPSHOTREFRESHTOPORDERS59_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(59);
    ...
    SnapshotRefreshTopOrders59() = default;
    ...
    SnapshotRefreshTopOrders59(char *buffer, const std::uint64_t bufferLength) :
        SnapshotRefreshTopOrders59(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SnapshotRefreshTopOrders59(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SnapshotRefreshTopOrders59(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    SnapshotRefreshTopOrders59 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = SnapshotRefreshTopOrders59(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    SnapshotRefreshTopOrders59 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotRefreshTopOrders59(
            buffer,
    ...
    SnapshotRefreshTopOrders59 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotRefreshTopOrders59(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    SnapshotRefreshTopOrders59 &sbeRewind()
    {
    ...
    {
        SnapshotRefreshTopOrders59 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    SnapshotRefreshTopOrders59 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotRefreshTopOrders59 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotRefreshTopOrders59 _writer)
{
    SnapshotRefreshTopOrders59 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SnapshotRefreshTopOrders59", )";
