...
#ifndef _SBE_COLLATERALMARKETVALUE62_H_
#define _SBE_COLLATERALMARKETVALUE62_H_
...
public:
    ...
    {
        return *this = CollateralMarketValue62(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    CollateralMarketValue62 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = CollateralMarketValue62(
            buffer,
    ...
    CollateralMarketValue62 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = CollateralMarketValue62(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        CollateralMarketValue62 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, CollateralMarketValue62 _writer)
{
