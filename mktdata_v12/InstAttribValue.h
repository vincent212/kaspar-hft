...
#ifndef _SBE_INSTATTRIBVALUE_H_
#define _SBE_INSTATTRIBVALUE_H_
...
public:
    ...
    static bool invertedBook(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 22u)) != 0;
    }

    static std::uint32_t invertedBook(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 22u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 22u));
    }

    SBE_NODISCARD bool invertedBook() const
    {
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 22u)) != 0;
    }

    InstAttribValue &invertedBook(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 22u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 22u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }

    static bool isAoNInstrument(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 23u)) != 0;
    }

    static std::uint32_t isAoNInstrument(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 23u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 23u));
    }

    SBE_NODISCARD bool isAoNInstrument() const
    {
        if (m_actingVersion < 10)
        {
            return false;
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 23u)) != 0;
    }

    InstAttribValue &isAoNInstrument(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 23u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 23u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }

    static bool sEFRegulated(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 24u)) != 0;
    }

    static std::uint32_t sEFRegulated(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 24u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 24u));
    }

    SBE_NODISCARD bool sEFRegulated() const
    {
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 24u)) != 0;
    }

    InstAttribValue &sEFRegulated(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 24u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 24u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }

    static bool mTFRegulated(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 25u)) != 0;
    }

    static std::uint32_t mTFRegulated(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 25u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 25u));
    }

    SBE_NODISCARD bool mTFRegulated() const
    {
        if (m_actingVersion < 12)
        {
            return false;
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 25u)) != 0;
    }

    InstAttribValue &mTFRegulated(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 25u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 25u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }

    static bool eFIXInstrument(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 26u)) != 0;
    }

    static std::uint32_t eFIXInstrument(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 26u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 26u));
    }

    SBE_NODISCARD bool eFIXInstrument() const
    {
        if (m_actingVersion < 12)
        {
            return false;
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 26u)) != 0;
    }

    InstAttribValue &eFIXInstrument(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 26u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 26u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }

    static bool hedgeInstrument(const std::uint32_t bits)
    {
        return (bits & (UINT32_C(0x1) << 27u)) != 0;
    }

    static std::uint32_t hedgeInstrument(const std::uint32_t bits, const bool value)
    {
        return value ? static_cast<std::uint32_t>(bits | (UINT32_C(0x1) << 27u)) : static_cast<std::uint32_t>(bits & ~(UINT32_C(0x1) << 27u));
    }

    SBE_NODISCARD bool hedgeInstrument() const
    {
        if (m_actingVersion < 12)
        {
            return false;
        ...
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset, sizeof(std::uint32_t));
        return (SBE_LITTLE_ENDIAN_ENCODE_32(val) & (UINT32_C(0x1) << 27u)) != 0;
    }

    InstAttribValue &hedgeInstrument(const bool value)
    {
        std::uint32_t bits;
        std::memcpy(&bits, m_buffer + m_offset, sizeof(std::uint32_t));
        bits = SBE_LITTLE_ENDIAN_ENCODE_32(value ? static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) | (UINT32_C(0x1) << 27u)) : static_cast<std::uint32_t>(SBE_LITTLE_ENDIAN_ENCODE_32(bits) & ~(UINT32_C(0x1) << 27u)));
        std::memcpy(m_buffer + m_offset, &bits, sizeof(std::uint32_t));
        return *this;
    }
        ...
        std::basic_ostream<CharT, Traits> &builder, InstAttribValue writer)
    {
        ...
        if (writer.invertedBook())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("invertedBook")";
            atLeastOne = true;
        }
        if (writer.isAoNInstrument())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("isAoNInstrument")";
            atLeastOne = true;
        }
        if (writer.sEFRegulated())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("sEFRegulated")";
            atLeastOne = true;
        }
        if (writer.mTFRegulated())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("mTFRegulated")";
            atLeastOne = true;
        }
        if (writer.eFIXInstrument())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("eFIXInstrument")";
            atLeastOne = true;
        }
        if (writer.hedgeInstrument())
        {
            if (atLeastOne)
            {
                builder << ",";
            }
            builder << R"("hedgeInstrument")";
        }
        builder << ']';
        return builder;
    }
