...
#ifndef _SBE_SNAPSHOTFULLREFRESHORDERBOOK53_H_
#define _SBE_SNAPSHOTFULLREFRESHORDERBOOK53_H_
...
public:
    ...
    {
        return *this = SnapshotFullRefreshOrderBook53(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    SnapshotFullRefreshOrderBook53 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefreshOrderBook53(
            buffer,
    ...
    SnapshotFullRefreshOrderBook53 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshOrderBook53(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefreshOrderBook53 _writer)
{
