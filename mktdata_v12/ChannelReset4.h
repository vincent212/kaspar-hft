...
#ifndef _SBE_CHANNELRESET4_H_
#define _SBE_CHANNELRESET4_H_
...
public:
    ...
    ChannelReset4(char *buffer, const std::uint64_t bufferLength) :
        ChannelReset4(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ChannelReset4(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ChannelReset4(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = ChannelReset4(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ChannelReset4 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ChannelReset4 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ChannelReset4(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ChannelReset4 &sbeRewind()
    {
    ...
    {
        ChannelReset4 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    ChannelReset4 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        {
            static const std::uint8_t mDEntryTypeValues[] = { 74, 0 };
        ...
        {
            static std::uint8_t mDEntryTypeValues[] = { 74 };
        ...
        {
            static const std::uint8_t MDEntryTypeValues[] = { 74 };
    ...
    #pragma clang diagnostic pop
        ...
        SBE_NODISCARD std::int16_t applID() const SBE_NOEXCEPT
        {
            ...
            std::int16_t val;
            std::memcpy(&val, m_buffer + m_offset + 0, sizeof(std::int16_t));
            return SBE_LITTLE_ENDIAN_ENCODE_16(val);
        }

        NoMDEntries &applID(const std::int16_t value) SBE_NOEXCEPT
        {
            std::int16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
            std::memcpy(m_buffer + m_offset + 0, &val, sizeof(std::int16_t));
            return *this;
        }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ChannelReset4 _writer)
{
    ChannelReset4 writer(
        _writer.m_buffer,
        _writer.m_offset,
