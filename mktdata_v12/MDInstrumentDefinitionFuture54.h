...
#ifndef _SBE_MDINSTRUMENTDEFINITIONFUTURE54_H_
#define _SBE_MDINSTRUMENTDEFINITIONFUTURE54_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(224);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(54);
    ...
    {
        return *this = MDInstrumentDefinitionFuture54(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    MDInstrumentDefinitionFuture54 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDInstrumentDefinitionFuture54(
            buffer,
    ...
    MDInstrumentDefinitionFuture54 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDInstrumentDefinitionFuture54(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDInstrumentDefinitionFuture54 _writer)
{
