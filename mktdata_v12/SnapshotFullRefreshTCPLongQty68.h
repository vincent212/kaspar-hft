...
#ifndef _SBE_SNAPSHOTFULLREFRESHTCPLONGQTY68_H_
#define _SBE_SNAPSHOTFULLREFRESHTCPLONGQTY68_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(68);
    ...
    {
        return *this = SnapshotFullRefreshTCPLongQty68(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    SnapshotFullRefreshTCPLongQty68 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefreshTCPLongQty68(
            buffer,
    ...
    SnapshotFullRefreshTCPLongQty68 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshTCPLongQty68(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefreshTCPLongQty68 _writer)
{
