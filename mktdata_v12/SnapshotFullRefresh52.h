...
#ifndef _SBE_SNAPSHOTFULLREFRESH52_H_
#define _SBE_SNAPSHOTFULLREFRESH52_H_
...
public:
    ...
    SnapshotFullRefresh52(char *buffer, const std::uint64_t bufferLength) :
        SnapshotFullRefresh52(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SnapshotFullRefresh52(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SnapshotFullRefresh52(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    SnapshotFullRefresh52 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefresh52(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    SnapshotFullRefresh52 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefresh52(
            buffer,
    ...
    SnapshotFullRefresh52 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefresh52(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    SnapshotFullRefresh52 &sbeRewind()
    {
    ...
    {
        SnapshotFullRefresh52 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &lastMsgSeqNumProcessed(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &lastUpdateTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefresh52 &mDSecurityTradingStatus(const SecurityTradingStatus::Value value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefresh52 _writer)
{
    SnapshotFullRefresh52 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SnapshotFullRefresh52", )";
