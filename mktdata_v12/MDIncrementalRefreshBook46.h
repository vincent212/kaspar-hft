...
#ifndef _SBE_MDINCREMENTALREFRESHBOOK46_H_
#define _SBE_MDINCREMENTALREFRESHBOOK46_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(46);
    ...
    MDIncrementalRefreshBook46() = default;
    ...
    MDIncrementalRefreshBook46(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshBook46(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshBook46(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshBook46(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MDIncrementalRefreshBook46 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshBook46(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshBook46 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshBook46(
            buffer,
    ...
    MDIncrementalRefreshBook46 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshBook46(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshBook46 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshBook46 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshBook46 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    #pragma clang diagnostic pop
        ...
        {
            char val;
            std::memcpy(&val, m_buffer + m_offset + 26, sizeof(char));
            return (val);
        }
        ...
        {
            char val = (value);
            std::memcpy(m_buffer + m_offset + 26, &val, sizeof(char));
            return *this;
        }
    ...
    #pragma clang diagnostic ignored "-Wtautological-compare"
    #endif
            return m_actingVersion >= tradeableSizeSinceVersion();
    #if defined(__clang__)
    #pragma clang diagnostic pop
    #endif
        }
        ...
        SBE_NODISCARD std::int32_t tradeableSize() const SBE_NOEXCEPT
        {
            ...
            std::int32_t val;
            std::memcpy(&val, m_buffer + m_offset + 27, sizeof(std::int32_t));
            return SBE_LITTLE_ENDIAN_ENCODE_32(val);
        }
        ...
        {
            std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
            std::memcpy(m_buffer + m_offset + 27, &val, sizeof(std::int32_t));
            return *this;
        }
...
#pragma clang diagnostic pop
    ...
    #pragma clang diagnostic pop
        ...
        NoOrderIDEntries &mDOrderPriority(const std::uint64_t value) SBE_NOEXCEPT
        {
            std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    #pragma clang diagnostic pop
        ...
        NoOrderIDEntries &mDDisplayQty(const std::int32_t value) SBE_NOEXCEPT
        {
            std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        ...
        SBE_NODISCARD static const char *ReferenceIDMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
        {
            switch (metaAttribute)
            {
                case MetaAttribute::SEMANTIC_TYPE: return "int";
        ...
        static SBE_CONSTEXPR std::uint16_t referenceIDId() SBE_NOEXCEPT
        {
            return 9633;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t referenceIDSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool referenceIDInActingVersion() SBE_NOEXCEPT
        {
    #if defined(__clang__)
    #pragma clang diagnostic push
    #pragma clang diagnostic ignored "-Wtautological-compare"
    ...
    #pragma clang diagnostic pop
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t referenceIDEncodingOffset() SBE_NOEXCEPT
        {
            return 20;
        }

        static SBE_CONSTEXPR std::uint8_t referenceIDNullValue() SBE_NOEXCEPT
        {
            return static_cast<std::uint8_t>(255);
        }

        static SBE_CONSTEXPR std::uint8_t referenceIDMinValue() SBE_NOEXCEPT
        {
            return static_cast<std::uint8_t>(0);
        }

        static SBE_CONSTEXPR std::uint8_t referenceIDMaxValue() SBE_NOEXCEPT
        {
            return static_cast<std::uint8_t>(254);
        }

        static SBE_CONSTEXPR std::size_t referenceIDEncodingLength() SBE_NOEXCEPT
        {
            return 1;
        }

        SBE_NODISCARD std::uint8_t referenceID() const SBE_NOEXCEPT
        {
            std::uint8_t val;
        ...
        NoOrderIDEntries &referenceID(const std::uint8_t value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
        ...
        SBE_NODISCARD static const char *OrderUpdateActionMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
        {
            switch (metaAttribute)
            {
                case MetaAttribute::SEMANTIC_TYPE: return "int";
        ...
        static SBE_CONSTEXPR std::uint16_t orderUpdateActionId() SBE_NOEXCEPT
        {
            return 37708;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t orderUpdateActionSinceVersion() SBE_NOEXCEPT
        {
            return 7;
        }

        SBE_NODISCARD bool orderUpdateActionInActingVersion() SBE_NOEXCEPT
        {
    #if defined(__clang__)
    #pragma clang diagnostic push
    #pragma clang diagnostic ignored "-Wtautological-compare"
    ...
    #pragma clang diagnostic pop
        ...
        SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderUpdateActionEncodingOffset() SBE_NOEXCEPT
        {
            return 21;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t orderUpdateActionEncodingLength() SBE_NOEXCEPT
        {
            return 1;
        }

        SBE_NODISCARD std::uint8_t orderUpdateActionRaw() const SBE_NOEXCEPT
        {
            if (m_actingVersion < 7)
            {
                return static_cast<std::uint8_t>(255);
        ...
        SBE_NODISCARD OrderUpdateAction::Value orderUpdateAction() const
        {
            if (m_actingVersion < 7)
            {
                return OrderUpdateAction::NULL_VALUE;
            }

            std::uint8_t val;
            std::memcpy(&val, m_buffer + m_offset + 21, sizeof(std::uint8_t));
            return OrderUpdateAction::get((val));
        }

        NoOrderIDEntries &orderUpdateAction(const OrderUpdateAction::Value value) SBE_NOEXCEPT
        {
            std::uint8_t val = (value);
            ...
            std::basic_ostream<CharT, Traits> &builder, NoOrderIDEntries writer)
        {
            ...
            builder << ", ";
            builder << R"("ReferenceID": )";
            builder << +writer.referenceID();

            builder << ", ";
            builder << R"("OrderUpdateAction": )";
            builder << '"' << writer.orderUpdateAction() << '"';
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshBook46 _writer)
{
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshBook46", )";
