...
#ifndef _SBE_MDINCREMENTALREFRESHBOOKLONGQTY64_H_
#define _SBE_MDINCREMENTALREFRESHBOOKLONGQTY64_H_
...
class MDIncrementalRefreshBookLongQty64
{
private:
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(64);
    ...
    MDIncrementalRefreshBookLongQty64() = default;
    ...
    MDIncrementalRefreshBookLongQty64(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshBookLongQty64(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshBookLongQty64(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshBookLongQty64(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MDIncrementalRefreshBookLongQty64 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshBookLongQty64(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshBookLongQty64 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshBookLongQty64(
            buffer,
    ...
    MDIncrementalRefreshBookLongQty64 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshBookLongQty64(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshBookLongQty64 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshBookLongQty64 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshBookLongQty64 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshBookLongQty64 _writer)
{
    MDIncrementalRefreshBookLongQty64 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshBookLongQty64", )";
