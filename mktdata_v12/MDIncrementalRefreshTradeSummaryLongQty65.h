...
#ifndef _SBE_MDINCREMENTALREFRESHTRADESUMMARYLONGQTY65_H_
#define _SBE_MDINCREMENTALREFRESHTRADESUMMARYLONGQTY65_H_
...
class MDIncrementalRefreshTradeSummaryLongQty65
{
private:
...
public:
    ...
    MDIncrementalRefreshTradeSummaryLongQty65() = default;
    ...
    MDIncrementalRefreshTradeSummaryLongQty65(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshTradeSummaryLongQty65(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshTradeSummaryLongQty65(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshTradeSummaryLongQty65(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MDIncrementalRefreshTradeSummaryLongQty65 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshTradeSummaryLongQty65(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshTradeSummaryLongQty65 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshTradeSummaryLongQty65(
            buffer,
    ...
    MDIncrementalRefreshTradeSummaryLongQty65 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshTradeSummaryLongQty65(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshTradeSummaryLongQty65 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshTradeSummaryLongQty65 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshTradeSummaryLongQty65 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshTradeSummaryLongQty65 _writer)
{
    MDIncrementalRefreshTradeSummaryLongQty65 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshTradeSummaryLongQty65", )";
