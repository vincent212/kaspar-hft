...
#ifndef _SBE_ORDERCANCELREPLACEREJECT536_CXX_H_
#define _SBE_ORDERCANCELREPLACEREJECT536_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(409);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(536);
    ...
    OrderCancelReplaceReject536(char *buffer, const std::uint64_t bufferLength) :
        OrderCancelReplaceReject536(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderCancelReplaceReject536(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderCancelReplaceReject536(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(409);
    }
    ...
    {
        return static_cast<std::uint16_t>(536);
    }
    ...
    OrderCancelReplaceReject536 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = OrderCancelReplaceReject536(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    OrderCancelReplaceReject536 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = OrderCancelReplaceReject536(
            buffer,
    ...
    OrderCancelReplaceReject536 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = OrderCancelReplaceReject536(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    OrderCancelReplaceReject536 &sbeRewind()
    {
    ...
    {
        OrderCancelReplaceReject536 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    OrderCancelReplaceReject536 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceReject536 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceReject536 &text(const std::uint64_t index, const char value)
    {
        if (index >= 256)
        {
    ...
    OrderCancelReplaceReject536 &putText(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceReject536 &putText(const std::string_view str)
    {
    ...
    #else
    OrderCancelReplaceReject536 &putText(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 256)
        {
    ...
    OrderCancelReplaceReject536 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    OrderCancelReplaceReject536 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceReject536 &putExecID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    #else
    OrderCancelReplaceReject536 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    OrderCancelReplaceReject536 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    std::uint64_t getSenderID(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 308, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    OrderCancelReplaceReject536 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceReject536 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    OrderCancelReplaceReject536 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    OrderCancelReplaceReject536 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    std::uint64_t getClOrdID(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 328, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    OrderCancelReplaceReject536 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceReject536 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    OrderCancelReplaceReject536 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    OrderCancelReplaceReject536 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceReject536 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceReject536 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceReject536 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceReject536 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    OrderCancelReplaceReject536 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 388, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    OrderCancelReplaceReject536 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceReject536 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    OrderCancelReplaceReject536 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    OrderCancelReplaceReject536 &cxlRejReason(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceReject536 &delayDuration(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 85, 0 };
    ...
    {
        static const std::uint8_t cxlRejResponseToValues[] = { 50, 0 };
    ...
    {
        static std::uint8_t cxlRejResponseToValues[] = { 50 };
        std::uint64_t bytesToCopy = length < sizeof(cxlRejResponseToValues) ? length : sizeof(cxlRejResponseToValues);

        std::memcpy(dst, cxlRejResponseToValues, static_cast<std::size_t>(bytesToCopy));
        return bytesToCopy;
    }

    std::string getCxlRejResponseToAsString() const
    {
        static const std::uint8_t CxlRejResponseToValues[] = { 50 };
    ...
    OrderCancelReplaceReject536 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceReject536 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceReject536 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceReject536 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    OrderCancelReplaceReject536 &delayToTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderCancelReplaceReject536 &_writer)
{
    OrderCancelReplaceReject536 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "OrderCancelReplaceReject536", )";
