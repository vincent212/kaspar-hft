...
#ifndef _SBE_EXECUTIONREPORTCANCEL534_CXX_H_
#define _SBE_EXECUTIONREPORTCANCEL534_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(247);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(534);
    ...
    ExecutionReportCancel534(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportCancel534(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportCancel534(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportCancel534(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(247);
    }
    ...
    {
        return static_cast<std::uint16_t>(534);
    }
    ...
    ExecutionReportCancel534 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportCancel534(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportCancel534 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportCancel534(
            buffer,
    ...
    ExecutionReportCancel534 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportCancel534(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportCancel534 &sbeRewind()
    {
    ...
    {
        ExecutionReportCancel534 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportCancel534 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportCancel534 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportCancel534 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportCancel534 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportCancel534 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportCancel534 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportCancel534 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportCancel534 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportCancel534 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportCancel534 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportCancel534 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportCancel534 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportCancel534 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &crossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &hostCrossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportCancel534 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    ExecutionReportCancel534 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    ExecutionReportCancel534 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    ExecutionReportCancel534 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportCancel534 &orderQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportCancel534 &cumQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportCancel534 &minQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportCancel534 &displayQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportCancel534 &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 191, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReportCancel534 &delayDuration(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 191, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 52, 0 };
    ...
    {
        static std::uint8_t ordStatusValues[] = { 52 };
        std::uint64_t bytesToCopy = length < sizeof(ordStatusValues) ? length : sizeof(ordStatusValues);

        std::memcpy(dst, ordStatusValues, static_cast<std::size_t>(bytesToCopy));
        return bytesToCopy;
    }

    std::string getOrdStatusAsString() const
    {
        static const std::uint8_t OrdStatusValues[] = { 52 };
    ...
    {
        static const std::uint8_t execTypeValues[] = { 52, 0 };
    ...
    {
        static std::uint8_t execTypeValues[] = { 52 };
    ...
    {
        static const std::uint8_t ExecTypeValues[] = { 52 };
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 193, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportCancel534 &ordType(const OrderType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 193, &val, sizeof(char));
        return *this;
    }
    ...
    ExecutionReportCancel534 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportCancel534 &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportCancel534 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportCancel534 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportCancel534 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportCancel534 &execRestatementReason(const ExecReason::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportCancel534 &crossType(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    ...
    {
        m_execInst.wrap(m_buffer, m_offset + 201, m_actingVersion, m_bufferLength);
        return m_execInst;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 202, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportCancel534 &executionMode(const ExecMode::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 202, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 203, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportCancel534 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 203, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 204, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportCancel534 &managedOrder(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 204, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 205, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportCancel534 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 205, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint64_t delayToTime() const SBE_NOEXCEPT
    {
        ...
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 206, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportCancel534 &delayToTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 206, &val, sizeof(std::uint64_t));
        return *this;
    }
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 214, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_reservationPrice.wrap(m_buffer, m_offset + 222, m_actingVersion, m_bufferLength);
    ...
    ExecutionReportCancel534 &priorityIndicator(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD char origOrderUser(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 231 + (index * 1), sizeof(char));
        return (val);
    }

    ExecutionReportCancel534 &origOrderUser(const std::uint64_t index, const char value)
    {
        if (index >= 8)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 231 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getOrigOrderUser(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 231, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    ExecutionReportCancel534 &putOrigOrderUser(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 231, src, sizeof(char) * 8);
        return *this;
    }

    SBE_NODISCARD std::string getOrigOrderUserAsString() const
    {
        const char *buffer = m_buffer + m_offset + 231;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putOrigOrderUser(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 231, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 231 + start] = 0;
        }

        return *this;
    }
    #else
    ExecutionReportCancel534 &putOrigOrderUser(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 231, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 231 + start] = 0;
        }
    ...
    SBE_NODISCARD char cancelText(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 239 + (index * 1), sizeof(char));
        return (val);
    }

    ExecutionReportCancel534 &cancelText(const std::uint64_t index, const char value)
    {
        if (index >= 8)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 239 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getCancelText(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 239, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    ExecutionReportCancel534 &putCancelText(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 239, src, sizeof(char) * 8);
        return *this;
    }

    SBE_NODISCARD std::string getCancelTextAsString() const
    {
        const char *buffer = m_buffer + m_offset + 239;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    ExecutionReportCancel534 &putCancelText(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 239, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 239 + start] = 0;
        }

        return *this;
    }
    #else
    ExecutionReportCancel534 &putCancelText(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 239, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 239 + start] = 0;
        }
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportCancel534 &_writer)
{
    ExecutionReportCancel534 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportCancel534", )";
