...
#ifndef _SBE_EXECUTIONREPORTNEW522_CXX_H_
#define _SBE_EXECUTIONREPORTNEW522_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(522);
    ...
    ExecutionReportNew522(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportNew522(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportNew522(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportNew522(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(522);
    }
    ...
    ExecutionReportNew522 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportNew522(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportNew522 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportNew522(
            buffer,
    ...
    ExecutionReportNew522 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportNew522(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportNew522 &sbeRewind()
    {
    ...
    {
        ExecutionReportNew522 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportNew522 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportNew522 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportNew522 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportNew522 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportNew522 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportNew522 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportNew522 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportNew522 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportNew522 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportNew522 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportNew522 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportNew522 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportNew522 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportNew522 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportNew522 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportNew522 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &crossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &hostCrossID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportNew522 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    ExecutionReportNew522 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportNew522 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    ExecutionReportNew522 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    ExecutionReportNew522 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportNew522 &orderQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportNew522 &minQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportNew522 &displayQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportNew522 &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportNew522 &delayDuration(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 48, 0 };
    ...
    {
        static std::uint8_t ordStatusValues[] = { 48 };
    ...
    {
        static const std::uint8_t OrdStatusValues[] = { 48 };
    ...
    {
        static const std::uint8_t execTypeValues[] = { 48, 0 };
    ...
    {
        static std::uint8_t execTypeValues[] = { 48 };
    ...
    {
        static const std::uint8_t ExecTypeValues[] = { 48 };
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 189, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportNew522 &ordType(const OrderType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 189, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 190, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportNew522 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 190, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    ExecutionReportNew522 &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &crossType(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    ...
    {
        m_execInst.wrap(m_buffer, m_offset + 196, m_actingVersion, m_bufferLength);
        return m_execInst;
    }
    ...
    ExecutionReportNew522 &executionMode(const ExecMode::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReportNew522 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &managedOrder(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportNew522 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::uint64_t delayToTime() const SBE_NOEXCEPT
    {
        ...
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 201, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportNew522 &delayToTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 201, &val, sizeof(std::uint64_t));
        return *this;
    }
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 209, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_reservationPrice.wrap(m_buffer, m_offset + 217, m_actingVersion, m_bufferLength);
    ...
    ExecutionReportNew522 &priorityIndicator(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportNew522 &_writer)
{
    ExecutionReportNew522 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportNew522", )";
