...
#ifndef _SBE_EXECUTIONREPORTPENDINGREPLACE565_CXX_H_
#define _SBE_EXECUTIONREPORTPENDINGREPLACE565_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(565);
    ...
    ExecutionReportPendingReplace565(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportPendingReplace565(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportPendingReplace565(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportPendingReplace565(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(565);
    }
    ...
    ExecutionReportPendingReplace565 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportPendingReplace565(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportPendingReplace565 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportPendingReplace565(
            buffer,
    ...
    ExecutionReportPendingReplace565 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportPendingReplace565(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportPendingReplace565 &sbeRewind()
    {
    ...
    {
        ExecutionReportPendingReplace565 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportPendingReplace565 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingReplace565 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingReplace565 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportPendingReplace565 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingReplace565 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportPendingReplace565 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportPendingReplace565 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportPendingReplace565 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingReplace565 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportPendingReplace565 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportPendingReplace565 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportPendingReplace565 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingReplace565 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportPendingReplace565 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportPendingReplace565 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingReplace565 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportPendingReplace565 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingReplace565 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingReplace565 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingReplace565 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    ExecutionReportPendingReplace565 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingReplace565 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    ExecutionReportPendingReplace565 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    ExecutionReportPendingReplace565 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingReplace565 &orderQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingReplace565 &cumQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingReplace565 &leavesQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingReplace565 &minQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingReplace565 &displayQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingReplace565 &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 69, 0 };
    ...
    {
        static std::uint8_t ordStatusValues[] = { 69 };
    ...
    {
        static const std::uint8_t OrdStatusValues[] = { 69 };
    ...
    {
        static const std::uint8_t execTypeValues[] = { 69, 0 };
    ...
    {
        static std::uint8_t execTypeValues[] = { 69 };
    ...
    {
        static const std::uint8_t ExecTypeValues[] = { 69 };
    ...
    ExecutionReportPendingReplace565 &ordType(const OrderType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReportPendingReplace565 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingReplace565 &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingReplace565 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingReplace565 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingReplace565 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingReplace565 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingReplace565 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 179, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportPendingReplace565 &delayToTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 179, &val, sizeof(std::uint64_t));
        return *this;
    }
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 187, m_actingVersion, m_bufferLength);
    ...
    ExecutionReportPendingReplace565 &priorityIndicator(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportPendingReplace565 &_writer)
{
    ExecutionReportPendingReplace565 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportPendingReplace565", )";
