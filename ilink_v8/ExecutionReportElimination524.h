...
#ifndef _SBE_EXECUTIONREPORTELIMINATION524_CXX_H_
#define _SBE_EXECUTIONREPORTELIMINATION524_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(524);
    ...
    {
        return static_cast<std::uint16_t>(524);
    }
    ...
    ExecutionReportElimination524 &sbeRewind()
    {
    ...
    {
        ExecutionReportElimination524 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
public:
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 67, 0 };
    ...
    {
        static const std::uint8_t execTypeValues[] = { 67, 0 };
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 202, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_reservationPrice.wrap(m_buffer, m_offset + 210, m_actingVersion, m_bufferLength);
    ...
    ExecutionReportElimination524 &priorityIndicator(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportElimination524 &_writer)
{
    ExecutionReportElimination524 writer(
        _writer.m_buffer,
        _writer.m_offset,
