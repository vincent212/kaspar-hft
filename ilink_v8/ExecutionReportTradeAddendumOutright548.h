...
#ifndef _SBE_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_CXX_H_
#define _SBE_EXECUTIONREPORTTRADEADDENDUMOUTRIGHT548_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(222);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(548);
    ...
    ExecutionReportTradeAddendumOutright548(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportTradeAddendumOutright548(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportTradeAddendumOutright548(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportTradeAddendumOutright548(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(222);
    }
    ...
    {
        return static_cast<std::uint16_t>(548);
    }
    ...
    ExecutionReportTradeAddendumOutright548 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportTradeAddendumOutright548(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportTradeAddendumOutright548 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportTradeAddendumOutright548(
            buffer,
    ...
    ExecutionReportTradeAddendumOutright548 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportTradeAddendumOutright548(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportTradeAddendumOutright548 &sbeRewind()
    {
    ...
    {
        ExecutionReportTradeAddendumOutright548 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportTradeAddendumOutright548 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumOutright548 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumOutright548 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumOutright548 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportTradeAddendumOutright548 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumOutright548 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportTradeAddendumOutright548 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumOutright548 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportTradeAddendumOutright548 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportTradeAddendumOutright548 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumOutright548 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumOutright548 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumOutright548 &secExecID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumOutright548 &origSecondaryExecutionID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumOutright548 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumOutright548 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    ExecutionReportTradeAddendumOutright548 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    ExecutionReportTradeAddendumOutright548 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumOutright548 &lastQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportTradeAddendumOutright548 &sideTradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportTradeAddendumOutright548 &origSideTradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportTradeAddendumOutright548 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumOutright548 &ordStatus(const OrdStatusTrdCxl::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &execType(const ExecTypTrdCxl::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumOutright548 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    ...
    {
        m_execInst.wrap(m_buffer, m_offset + 176, m_actingVersion, m_bufferLength);
        return m_execInst;
    }
    ...
    ExecutionReportTradeAddendumOutright548 &executionMode(const ExecMode::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &managedOrder(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportTradeAddendumOutright548 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 181, m_actingVersion, m_bufferLength);
    ...
    ExecutionReportTradeAddendumOutright548 &trdType(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
    ...
    ExecutionReportTradeAddendumOutright548 &execRestatementReason(const ExecReason::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::uint16_t settlDate() const SBE_NOEXCEPT
    {
        ...
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 192, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReportTradeAddendumOutright548 &settlDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 192, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    SBE_NODISCARD std::uint16_t maturityDate() const SBE_NOEXCEPT
    {
        ...
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 194, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReportTradeAddendumOutright548 &maturityDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 194, &val, sizeof(std::uint16_t));
        return *this;
    }
...
public:
    ...
    {
        m_calculatedCcyLastQty.wrap(m_buffer, m_offset + 196, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_grossTradeAmt.wrap(m_buffer, m_offset + 205, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_benchmarkPrice.wrap(m_buffer, m_offset + 214, m_actingVersion, m_bufferLength);
...
public:
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(45));
            dimensions.numInGroup(static_cast<std::uint8_t>(count));
            m_index = 0;
            m_count = count;
            m_blockLength = 45;
...
public:
        ...
        {
            m_contraGrossTradeAmt.wrap(m_buffer, m_offset + 27, m_actingVersion, m_bufferLength);
...
public:
        ...
        {
            m_contraCalculatedCcyLastQty.wrap(m_buffer, m_offset + 36, m_actingVersion, m_bufferLength);
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportTradeAddendumOutright548 &_writer)
{
    ExecutionReportTradeAddendumOutright548 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportTradeAddendumOutright548", )";
