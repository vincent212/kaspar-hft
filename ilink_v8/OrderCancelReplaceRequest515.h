...
#ifndef _SBE_ORDERCANCELREPLACEREQUEST515_CXX_H_
#define _SBE_ORDERCANCELREPLACEREQUEST515_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(133);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(515);
    ...
    OrderCancelReplaceRequest515(char *buffer, const std::uint64_t bufferLength) :
        OrderCancelReplaceRequest515(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderCancelReplaceRequest515(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderCancelReplaceRequest515(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(515);
    }
    ...
    OrderCancelReplaceRequest515 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = OrderCancelReplaceRequest515(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    OrderCancelReplaceRequest515 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = OrderCancelReplaceRequest515(
            buffer,
    ...
    OrderCancelReplaceRequest515 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = OrderCancelReplaceRequest515(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    OrderCancelReplaceRequest515 &sbeRewind()
    {
    ...
    {
        OrderCancelReplaceRequest515 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
public:
    ...
    OrderCancelReplaceRequest515 &orderQty(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest515 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest515 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest515 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    OrderCancelReplaceRequest515 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    OrderCancelReplaceRequest515 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest515 &putSenderID(const std::string_view str)
    {
    ...
    #else
    OrderCancelReplaceRequest515 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    OrderCancelReplaceRequest515 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    OrderCancelReplaceRequest515 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest515 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    OrderCancelReplaceRequest515 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    OrderCancelReplaceRequest515 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest515 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_stopPx.wrap(m_buffer, m_offset + 77, m_actingVersion, m_bufferLength);
        return m_stopPx;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 85, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderCancelReplaceRequest515 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 85, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 93, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    OrderCancelReplaceRequest515 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 93, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    SBE_NODISCARD char location(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 101 + (index * 1), sizeof(char));
        return (val);
    }

    OrderCancelReplaceRequest515 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 101 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 101, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    OrderCancelReplaceRequest515 &putLocation(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 101, src, sizeof(char) * 5);
        return *this;
    }

    SBE_NODISCARD std::string getLocationAsString() const
    {
        const char *buffer = m_buffer + m_offset + 101;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    OrderCancelReplaceRequest515 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 101, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 101 + start] = 0;
        }

        return *this;
    }
    #else
    OrderCancelReplaceRequest515 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 101, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 101 + start] = 0;
        }
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 106, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    OrderCancelReplaceRequest515 &minQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 106, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 110, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    OrderCancelReplaceRequest515 &displayQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 110, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    OrderCancelReplaceRequest515 &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    OrderCancelReplaceRequest515 &ordType(const OrderTypeReq::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 117, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderCancelReplaceRequest515 &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 117, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    OrderCancelReplaceRequest515 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD std::uint8_t oFMOverrideRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 119, sizeof(std::uint8_t));
        return (val);
    }

    SBE_NODISCARD OFMOverrideReq::Value oFMOverride() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 119, sizeof(std::uint8_t));
        return OFMOverrideReq::get((val));
    }

    OrderCancelReplaceRequest515 &oFMOverride(const OFMOverrideReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 119, &val, sizeof(std::uint8_t));
        return *this;
    }
...
public:
    ...
    {
        m_execInst.wrap(m_buffer, m_offset + 120, m_actingVersion, m_bufferLength);
        return m_execInst;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 121, sizeof(char));
        return (val);
    }
    ...
    OrderCancelReplaceRequest515 &executionMode(const ExecMode::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 121, &val, sizeof(char));
        return *this;
    }
    ...
    OrderCancelReplaceRequest515 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 123, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderCancelReplaceRequest515 &managedOrder(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 123, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 124, sizeof(std::uint8_t));
        return (val);
    }
    ...
    OrderCancelReplaceRequest515 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 124, &val, sizeof(std::uint8_t));
        return *this;
    }
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 125, m_actingVersion, m_bufferLength);
        return m_discretionPrice;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderCancelReplaceRequest515 &_writer)
{
    OrderCancelReplaceRequest515 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "OrderCancelReplaceRequest515", )";
