...
#ifndef _SBE_ESTABLISHMENTREJECT505_CXX_H_
#define _SBE_ESTABLISHMENTREJECT505_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(505);
    ...
    EstablishmentReject505(char *buffer, const std::uint64_t bufferLength) :
        EstablishmentReject505(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    EstablishmentReject505(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        EstablishmentReject505(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(505);
    }
    ...
    EstablishmentReject505 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = EstablishmentReject505(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    EstablishmentReject505 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = EstablishmentReject505(
            buffer,
    ...
    EstablishmentReject505 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = EstablishmentReject505(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    EstablishmentReject505 &sbeRewind()
    {
    ...
    {
        EstablishmentReject505 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    EstablishmentReject505 &reason(const std::uint64_t index, const char value)
    {
        if (index >= 48)
        {
    ...
    EstablishmentReject505 &putReason(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    EstablishmentReject505 &putReason(const std::string_view str)
    {
    ...
    #else
    EstablishmentReject505 &putReason(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 48)
        {
    ...
    EstablishmentReject505 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    EstablishmentReject505 &requestTimestamp(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 64, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    EstablishmentReject505 &nextSeqNo(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 64, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 68, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    EstablishmentReject505 &errorCodes(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 68, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    EstablishmentReject505 &faultToleranceIndicator(const FTI::Value value) SBE_NOEXCEPT
    {
    ...
    EstablishmentReject505 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const EstablishmentReject505 &_writer)
{
    EstablishmentReject505 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "EstablishmentReject505", )";
