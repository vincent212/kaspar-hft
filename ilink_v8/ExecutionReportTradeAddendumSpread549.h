...
#ifndef _SBE_EXECUTIONREPORTTRADEADDENDUMSPREAD549_CXX_H_
#define _SBE_EXECUTIONREPORTTRADEADDENDUMSPREAD549_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(187);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(549);
    ...
    ExecutionReportTradeAddendumSpread549(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportTradeAddendumSpread549(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportTradeAddendumSpread549(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportTradeAddendumSpread549(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(187);
    }
    ...
    {
        return static_cast<std::uint16_t>(549);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportTradeAddendumSpread549(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportTradeAddendumSpread549 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportTradeAddendumSpread549(
            buffer,
    ...
    ExecutionReportTradeAddendumSpread549 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportTradeAddendumSpread549(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportTradeAddendumSpread549 &sbeRewind()
    {
    ...
    {
        ExecutionReportTradeAddendumSpread549 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportTradeAddendumSpread549 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumSpread549 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumSpread549 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumSpread549 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportTradeAddendumSpread549 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumSpread549 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportTradeAddendumSpread549 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumSpread549 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportTradeAddendumSpread549 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportTradeAddendumSpread549 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumSpread549 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumSpread549 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumSpread549 &secExecID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumSpread549 &origSecondaryExecutionID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportTradeAddendumSpread549 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &putLocation(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportTradeAddendumSpread549 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    #else
    ExecutionReportTradeAddendumSpread549 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
    ...
    ExecutionReportTradeAddendumSpread549 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportTradeAddendumSpread549 &mDTradeEntryID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportTradeAddendumSpread549 &lastQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportTradeAddendumSpread549 &sideTradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 169, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReportTradeAddendumSpread549 &origSideTradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 169, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    {
        std::uint16_t val;
        std::memcpy(&val, m_buffer + m_offset + 173, sizeof(std::uint16_t));
        return SBE_LITTLE_ENDIAN_ENCODE_16(val);
    }

    ExecutionReportTradeAddendumSpread549 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
        std::memcpy(m_buffer + m_offset + 173, &val, sizeof(std::uint16_t));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 175, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &ordStatus(const OrdStatusTrdCxl::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 175, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 176, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &execType(const ExecTypTrdCxl::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 176, &val, sizeof(char));
        return *this;
    }
    ...
    ExecutionReportTradeAddendumSpread549 &ordType(const OrderType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 178, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 178, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 179, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 179, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 180, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 180, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 181, sizeof(std::uint8_t));
        return (val);
    }

    ExecutionReportTradeAddendumSpread549 &totalNumSecurities(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 181, &val, sizeof(std::uint8_t));
        return *this;
    }
...
public:
    ...
    {
        m_execInst.wrap(m_buffer, m_offset + 182, m_actingVersion, m_bufferLength);
        return m_execInst;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 183, sizeof(char));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &executionMode(const ExecMode::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 183, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 184, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 184, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 185, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &managedOrder(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 185, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 186, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportTradeAddendumSpread549 &shortSaleType(const ShortSaleType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 186, &val, sizeof(std::uint8_t));
        return *this;
    }
...
public:
        ...
        SBE_NODISCARD static const char *LegExecRefIDMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
        {
            switch (metaAttribute)
            {
                case MetaAttribute::SEMANTIC_TYPE: return "int";
        ...
        static SBE_CONSTEXPR std::uint16_t legExecRefIDId() SBE_NOEXCEPT
        {
            return 1901;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t legExecRefIDSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool legExecRefIDInActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t legExecRefIDEncodingOffset() SBE_NOEXCEPT
        {
            return 16;
        }

        static SBE_CONSTEXPR std::uint64_t legExecRefIDNullValue() SBE_NOEXCEPT
        {
            return UINT64_C(0xffffffffffffffff);
        }

        static SBE_CONSTEXPR std::uint64_t legExecRefIDMinValue() SBE_NOEXCEPT
        {
            return UINT64_C(0x0);
        }

        static SBE_CONSTEXPR std::uint64_t legExecRefIDMaxValue() SBE_NOEXCEPT
        {
            return UINT64_C(0xfffffffffffffffe);
        }

        static SBE_CONSTEXPR std::size_t legExecRefIDEncodingLength() SBE_NOEXCEPT
        {
            return 8;
        }

        SBE_NODISCARD std::uint64_t legExecRefID() const SBE_NOEXCEPT
        {
            std::uint64_t val;
        ...
        NoLegs &legExecRefID(const std::uint64_t value) SBE_NOEXCEPT
        {
            std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        ...
        SBE_NODISCARD static const char *LegTradeRefIDMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
        {
            switch (metaAttribute)
            {
                case MetaAttribute::SEMANTIC_TYPE: return "int";
        ...
        static SBE_CONSTEXPR std::uint16_t legTradeRefIDId() SBE_NOEXCEPT
        {
            return 39023;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t legTradeRefIDSinceVersion() SBE_NOEXCEPT
        {
            return 0;
        }

        SBE_NODISCARD bool legTradeRefIDInActingVersion() SBE_NOEXCEPT
        {
            return true;
        }

        SBE_NODISCARD static SBE_CONSTEXPR std::size_t legTradeRefIDEncodingOffset() SBE_NOEXCEPT
        {
            return 28;
        }

        static SBE_CONSTEXPR std::uint32_t legTradeRefIDNullValue() SBE_NOEXCEPT
        {
            return UINT32_C(0xffffffff);
        }

        static SBE_CONSTEXPR std::uint32_t legTradeRefIDMinValue() SBE_NOEXCEPT
        {
            return UINT32_C(0x0);
        }

        static SBE_CONSTEXPR std::uint32_t legTradeRefIDMaxValue() SBE_NOEXCEPT
        {
            return UINT32_C(0xfffffffe);
        }

        static SBE_CONSTEXPR std::size_t legTradeRefIDEncodingLength() SBE_NOEXCEPT
        {
            return 4;
        }

        SBE_NODISCARD std::uint32_t legTradeRefID() const SBE_NOEXCEPT
        {
            std::uint32_t val;
        ...
        NoLegs &legTradeRefID(const std::uint32_t value) SBE_NOEXCEPT
        {
            std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
            ...
            std::basic_ostream<CharT, Traits> &builder, NoLegs &writer)
        {
            ...
            builder << ", ";
            builder << R"("LegExecRefID": )";
            builder << +writer.legExecRefID();
            ...
            builder << ", ";
            builder << R"("LegTradeRefID": )";
            builder << +writer.legTradeRefID();
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportTradeAddendumSpread549 &_writer)
{
    ExecutionReportTradeAddendumSpread549 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportTradeAddendumSpread549", )";
