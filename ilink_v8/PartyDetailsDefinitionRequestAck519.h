...
#ifndef _SBE_PARTYDETAILSDEFINITIONREQUESTACK519_CXX_H_
#define _SBE_PARTYDETAILSDEFINITIONREQUESTACK519_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(159);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(519);
    ...
    PartyDetailsDefinitionRequestAck519(
        char *buffer,
    ...
    PartyDetailsDefinitionRequestAck519(char *buffer, const std::uint64_t bufferLength) :
        PartyDetailsDefinitionRequestAck519(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    PartyDetailsDefinitionRequestAck519(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        PartyDetailsDefinitionRequestAck519(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(159);
    }
    ...
    {
        return static_cast<std::uint16_t>(519);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = PartyDetailsDefinitionRequestAck519(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    PartyDetailsDefinitionRequestAck519 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = PartyDetailsDefinitionRequestAck519(
            buffer,
    ...
    PartyDetailsDefinitionRequestAck519 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = PartyDetailsDefinitionRequestAck519(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    PartyDetailsDefinitionRequestAck519 &sbeRewind()
    {
    ...
    {
        PartyDetailsDefinitionRequestAck519 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    PartyDetailsDefinitionRequestAck519 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    PartyDetailsDefinitionRequestAck519 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    PartyDetailsDefinitionRequestAck519 &memo(const std::uint64_t index, const char value)
    {
        if (index >= 75)
        {
    ...
    PartyDetailsDefinitionRequestAck519 &putMemo(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 12, src, sizeof(char) * 75);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    PartyDetailsDefinitionRequestAck519 &putMemo(const std::string_view str)
    {
    ...
    #else
    PartyDetailsDefinitionRequestAck519 &putMemo(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 75)
        {
    ...
    SBE_NODISCARD char avgPxGroupID(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 87 + (index * 1), sizeof(char));
        return (val);
    }

    PartyDetailsDefinitionRequestAck519 &avgPxGroupID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 87 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getAvgPxGroupID(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 87, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    PartyDetailsDefinitionRequestAck519 &putAvgPxGroupID(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 87, src, sizeof(char) * 20);
        return *this;
    }

    SBE_NODISCARD std::string getAvgPxGroupIDAsString() const
    {
        const char *buffer = m_buffer + m_offset + 87;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    PartyDetailsDefinitionRequestAck519 &putAvgPxGroupID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
        ...
        std::memcpy(m_buffer + m_offset + 87, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 20; ++start)
        {
            m_buffer[m_offset + 87 + start] = 0;
        }

        return *this;
    }
    #else
    PartyDetailsDefinitionRequestAck519 &putAvgPxGroupID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
        ...
        std::memcpy(m_buffer + m_offset + 87, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 20; ++start)
        {
            m_buffer[m_offset + 87 + start] = 0;
        }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 107, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    PartyDetailsDefinitionRequestAck519 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 107, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 115, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    PartyDetailsDefinitionRequestAck519 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 115, &val, sizeof(std::uint64_t));
        return *this;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 123, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    PartyDetailsDefinitionRequestAck519 &selfMatchPreventionID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 123, &val, sizeof(std::uint64_t));
        return *this;
    }

    SBE_NODISCARD static const char *PartyDetailRequestStatusMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::SEMANTIC_TYPE: return "int";
    ...
    static SBE_CONSTEXPR std::uint16_t partyDetailRequestStatusId() SBE_NOEXCEPT
    {
        return 1878;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t partyDetailRequestStatusSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool partyDetailRequestStatusInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t partyDetailRequestStatusEncodingOffset() SBE_NOEXCEPT
    {
        return 131;
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailRequestStatusNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT8;
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailRequestStatusMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailRequestStatusMaxValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(254);
    }

    static SBE_CONSTEXPR std::size_t partyDetailRequestStatusEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t partyDetailRequestStatus() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    PartyDetailsDefinitionRequestAck519 &partyDetailRequestStatus(const std::uint8_t value) SBE_NOEXCEPT
    {
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 132, sizeof(std::uint8_t));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &custOrderCapacity(const CustOrderCapacity::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 132, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    PartyDetailsDefinitionRequestAck519 &clearingAccountType(const ClearingAcctType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 134, sizeof(char));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &selfMatchPreventionInstruction(const SMPI::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 134, &val, sizeof(char));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 135, sizeof(std::uint8_t));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &avgPxIndicator(const AvgPxInd::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 135, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    PartyDetailsDefinitionRequestAck519 &clearingTradePriceType(const SLEDS::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 137, sizeof(char));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &cmtaGiveupCD(const CmtaGiveUpCD::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 137, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 138, sizeof(char));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &custOrderHandlingInst(const CustOrdHandlInst::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 138, &val, sizeof(char));
        return *this;
    }
    ...
    {
        char val;
        std::memcpy(&val, m_buffer + m_offset + 139, sizeof(char));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &listUpdateAction(const ListUpdAct::Value value) SBE_NOEXCEPT
    {
        char val = (value);
        std::memcpy(m_buffer + m_offset + 139, &val, sizeof(char));
        return *this;
    }

    SBE_NODISCARD static const char *PartyDetailDefinitionStatusMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::SEMANTIC_TYPE: return "int";
    ...
    static SBE_CONSTEXPR std::uint16_t partyDetailDefinitionStatusId() SBE_NOEXCEPT
    {
        return 1879;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t partyDetailDefinitionStatusSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool partyDetailDefinitionStatusInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t partyDetailDefinitionStatusEncodingOffset() SBE_NOEXCEPT
    {
        return 140;
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailDefinitionStatusNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT8;
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailDefinitionStatusMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }

    static SBE_CONSTEXPR std::uint8_t partyDetailDefinitionStatusMaxValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(254);
    }

    static SBE_CONSTEXPR std::size_t partyDetailDefinitionStatusEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t partyDetailDefinitionStatus() const SBE_NOEXCEPT
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 140, sizeof(std::uint8_t));
        return (val);
    }

    PartyDetailsDefinitionRequestAck519 &partyDetailDefinitionStatus(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 140, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    PartyDetailsDefinitionRequestAck519 &executor(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    PartyDetailsDefinitionRequestAck519 &iDMShortCode(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 157, sizeof(std::uint8_t));
        return (val);
    }
    ...
    PartyDetailsDefinitionRequestAck519 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 157, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    PartyDetailsDefinitionRequestAck519 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const PartyDetailsDefinitionRequestAck519 &_writer)
{
    PartyDetailsDefinitionRequestAck519 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "PartyDetailsDefinitionRequestAck519", )";
    ...
    builder << ", ";
    builder << R"("PartyDetailRequestStatus": )";
    builder << +writer.partyDetailRequestStatus();
    ...
    builder << ", ";
    builder << R"("PartyDetailDefinitionStatus": )";
    builder << +writer.partyDetailDefinitionStatus();
