...
#ifndef _SBE_ORDERCANCELREJECT535_CXX_H_
#define _SBE_ORDERCANCELREJECT535_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(535);
    ...
    {
        return static_cast<std::uint16_t>(535);
    }
    ...
    OrderCancelReject535 &sbeRewind()
    {
    ...
    {
        OrderCancelReject535 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        static const std::uint8_t cxlRejResponseToValues[] = { 49, 0 };
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderCancelReject535 &_writer)
{
    OrderCancelReject535 writer(
        _writer.m_buffer,
        _writer.m_offset,
