...
#ifndef _SBE_NEGOTIATIONREJECT502_CXX_H_
#define _SBE_NEGOTIATIONREJECT502_CXX_H_
...
public:
    ...
    NegotiationReject502 &sbeRewind()
    {
    ...
    {
        NegotiationReject502 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const NegotiationReject502 &_writer)
{
    NegotiationReject502 writer(
        _writer.m_buffer,
        _writer.m_offset,
