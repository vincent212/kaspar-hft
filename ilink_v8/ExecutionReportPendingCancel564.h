...
#ifndef _SBE_EXECUTIONREPORTPENDINGCANCEL564_CXX_H_
#define _SBE_EXECUTIONREPORTPENDINGCANCEL564_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(564);
    ...
    ExecutionReportPendingCancel564(char *buffer, const std::uint64_t bufferLength) :
        ExecutionReportPendingCancel564(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionReportPendingCancel564(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionReportPendingCancel564(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(564);
    }
    ...
    ExecutionReportPendingCancel564 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportPendingCancel564(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    ExecutionReportPendingCancel564 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExecutionReportPendingCancel564(
            buffer,
    ...
    ExecutionReportPendingCancel564 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = ExecutionReportPendingCancel564(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    ExecutionReportPendingCancel564 &sbeRewind()
    {
    ...
    {
        ExecutionReportPendingCancel564 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionReportPendingCancel564 &seqNum(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingCancel564 &uUID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    ExecutionReportPendingCancel564 &execID(const std::uint64_t index, const char value)
    {
        if (index >= 40)
        {
    ...
    ExecutionReportPendingCancel564 &putExecID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putExecID(const std::string_view str)
    {
    ...
    #else
    ExecutionReportPendingCancel564 &putExecID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 40)
        {
    ...
    ExecutionReportPendingCancel564 &senderID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportPendingCancel564 &putSenderID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putSenderID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportPendingCancel564 &putSenderID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportPendingCancel564 &clOrdID(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    ExecutionReportPendingCancel564 &putClOrdID(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putClOrdID(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    #else
    ExecutionReportPendingCancel564 &putClOrdID(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
    ...
    ExecutionReportPendingCancel564 &partyDetailsListReqID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingCancel564 &orderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    ExecutionReportPendingCancel564 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingCancel564 &sendingTimeEpoch(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    ExecutionReportPendingCancel564 &orderRequestID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD char location(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 140 + (index * 1), sizeof(char));
        return (val);
    }

    ExecutionReportPendingCancel564 &location(const std::uint64_t index, const char value)
    {
        if (index >= 5)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 140 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getLocation(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 140, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    ExecutionReportPendingCancel564 &putLocation(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 140, src, sizeof(char) * 5);
        return *this;
    }

    SBE_NODISCARD std::string getLocationAsString() const
    {
        const char *buffer = m_buffer + m_offset + 140;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putLocation(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 140, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 140 + start] = 0;
        }

        return *this;
    }
    #else
    ExecutionReportPendingCancel564 &putLocation(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 5)
        {
        ...
        std::memcpy(m_buffer + m_offset + 140, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 5; ++start)
        {
            m_buffer[m_offset + 140 + start] = 0;
        }
    ...
    {
        std::int32_t val;
        std::memcpy(&val, m_buffer + m_offset + 145, sizeof(std::int32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReportPendingCancel564 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 145, &val, sizeof(std::int32_t));
        return *this;
    }
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 149, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReportPendingCancel564 &orderQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 149, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 153, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionReportPendingCancel564 &cumQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 153, &val, sizeof(std::uint32_t));
        return *this;
    }
    ...
    ExecutionReportPendingCancel564 &leavesQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingCancel564 &minQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingCancel564 &displayQty(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ExecutionReportPendingCancel564 &expireDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    {
        static const std::uint8_t ordStatusValues[] = { 54, 0 };
    ...
    {
        static std::uint8_t ordStatusValues[] = { 54 };
    ...
    {
        static const std::uint8_t OrdStatusValues[] = { 54 };
    ...
    {
        static const std::uint8_t execTypeValues[] = { 54, 0 };
    ...
    {
        static std::uint8_t execTypeValues[] = { 54 };
    ...
    {
        static const std::uint8_t ExecTypeValues[] = { 54 };
    ...
    ExecutionReportPendingCancel564 &ordType(const OrderType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 172, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportPendingCancel564 &side(const SideReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 172, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    ExecutionReportPendingCancel564 &timeInForce(const TimeInForce::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingCancel564 &manualOrderIndicator(const ManualOrdIndReq::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    ExecutionReportPendingCancel564 &possRetransFlag(const BooleanFlag::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 176, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportPendingCancel564 &splitMsg(const SplitMsg::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 176, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 177, sizeof(std::uint8_t));
        return (val);
    }
    ...
    ExecutionReportPendingCancel564 &liquidityFlag(const BooleanNULL::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 177, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    {
        std::uint64_t val;
        std::memcpy(&val, m_buffer + m_offset + 178, sizeof(std::uint64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    ExecutionReportPendingCancel564 &delayToTime(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 178, &val, sizeof(std::uint64_t));
        return *this;
    }
...
public:
    ...
    {
        m_discretionPrice.wrap(m_buffer, m_offset + 186, m_actingVersion, m_bufferLength);
...
public:
    ...
    {
        m_reservationPrice.wrap(m_buffer, m_offset + 194, m_actingVersion, m_bufferLength);
    ...
    SBE_NODISCARD std::uint8_t priorityIndicator() const SBE_NOEXCEPT
    {
        ...
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 202, sizeof(std::uint8_t));
        return (val);
    }

    ExecutionReportPendingCancel564 &priorityIndicator(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
        std::memcpy(m_buffer + m_offset + 202, &val, sizeof(std::uint8_t));
        return *this;
    }
    ...
    SBE_NODISCARD char origOrderUser(const std::uint64_t index) const
    {
        ...
        char val;
        std::memcpy(&val, m_buffer + m_offset + 203 + (index * 1), sizeof(char));
        return (val);
    }

    ExecutionReportPendingCancel564 &origOrderUser(const std::uint64_t index, const char value)
    {
        if (index >= 8)
        {
        ...
        char val = (value);
        std::memcpy(m_buffer + m_offset + 203 + (index * 1), &val, sizeof(char));
        return *this;
    }
    ...
    std::uint64_t getOrigOrderUser(char *const dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, m_buffer + m_offset + 203, sizeof(char) * static_cast<std::size_t>(length));
        return length;
    }

    ExecutionReportPendingCancel564 &putOrigOrderUser(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 203, src, sizeof(char) * 8);
        return *this;
    }

    SBE_NODISCARD std::string getOrigOrderUserAsString() const
    {
        const char *buffer = m_buffer + m_offset + 203;
        std::size_t length = 0;
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putOrigOrderUser(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 203, str.data(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 203 + start] = 0;
        }

        return *this;
    }
    #else
    ExecutionReportPendingCancel564 &putOrigOrderUser(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
        ...
        std::memcpy(m_buffer + m_offset + 203, str.c_str(), srcLength);
        for (std::size_t start = srcLength; start < 8; ++start)
        {
            m_buffer[m_offset + 203 + start] = 0;
        }
    ...
    ExecutionReportPendingCancel564 &cancelText(const std::uint64_t index, const char value)
    {
        if (index >= 8)
        {
    ...
    ExecutionReportPendingCancel564 &putCancelText(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 211, src, sizeof(char) * 8);
        return *this;
    }
    ...
    #if __cplusplus >= 201703L
    ExecutionReportPendingCancel564 &putCancelText(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
    ...
    #else
    ExecutionReportPendingCancel564 &putCancelText(const std::string &str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 8)
        {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionReportPendingCancel564 &_writer)
{
    ExecutionReportPendingCancel564 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionReportPendingCancel564", )";
