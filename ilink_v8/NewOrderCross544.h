...
#ifndef _SBE_NEWORDERCROSS544_CXX_H_
#define _SBE_NEWORDERCROSS544_CXX_H_
...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(544);
    ...
    {
        return static_cast<std::uint16_t>(544);
    }
    ...
    {
        NewOrderCross544 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        static const std::uint8_t ordTypeValues[] = { 50, 0 };
    ...
    std::uint64_t getOrdType(char *dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, ordTypeValues, static_cast<std::size_t>(bytesToCopy));
        return bytesToCopy;
    }
    ...
    {
        static const std::uint8_t crossTypeValues[] = { 51, 0 };
    ...
    std::uint64_t getCrossType(char *dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, crossTypeValues, static_cast<std::size_t>(bytesToCopy));
        return bytesToCopy;
    }
    ...
    {
        static const std::uint8_t crossPrioritizationValues[] = { 48, 0 };
    ...
    std::uint64_t getCrossPrioritization(char *dst, const std::uint64_t length) const
    {
        ...
        std::memcpy(dst, crossPrioritizationValues, static_cast<std::size_t>(bytesToCopy));
        return bytesToCopy;
    }
...
public:
    ...
    #pragma GCC diagnostic pop
            ...
            m_bufferLength = bufferLength;
            GroupSize dimensions(buffer, *pos, bufferLength, actingVersion);
            dimensions.blockLength(static_cast<std::uint16_t>(34));
        ...
        SBE_NODISCARD std::uint8_t sideTimeInForceRaw() const SBE_NOEXCEPT
        {
            std::uint8_t val;
        ...
        SBE_NODISCARD SideTimeInForce::Value sideTimeInForce() const
        {
            std::uint8_t val;
            std::memcpy(&val, m_buffer + m_offset + 33, sizeof(std::uint8_t));
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const NewOrderCross544 &_writer)
{
    NewOrderCross544 writer(
        _writer.m_buffer,
        _writer.m_offset,
...
SBE_NODISCARD static std::size_t computeLength(std::size_t noSidesLength = 0)
{
#if defined(__GNUG__) && !defined(__clang__)
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wtype-limits"
