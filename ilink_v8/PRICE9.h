...
#ifndef _SBE_PRICE9_CXX_H_
#define _SBE_PRICE9_CXX_H_
...
public:
    ...
    PRICE9(
        ...
        const std::uint64_t bufferLength,
        const std::uint64_t actingVersion) :
        PRICE9(buffer, 0, bufferLength, actingVersion)
    {
    }
    ...
    PRICE9(
        char *buffer,
        const std::uint64_t bufferLength) :
        PRICE9(buffer, 0, bufferLength, sbeSchemaVersion())
    {
    }
    ...
    PRICE9 &wrap(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = PRICE9(buffer, offset, bufferLength, actingVersion);
    }
    ...
    PRICE9 &mantissa(const std::int64_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, PRICE9 &writer)
{
    builder << '{';
    builder << R"("mantissa": )";
