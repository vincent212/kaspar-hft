...
#
# Usage:  ./extract_btc_2024.sh                # all 2024 dates
#         NJOBS=6 ./extract_btc_2024.sh        # tune parallelism (default 8)
...
total=${#DATES[@]}
echo "extract_btc_2024: $total dates, chan=$CHAN (consolidated), NJOBS=$NJOBS, nice=$NICE_LEVEL"
echo "src: $SRC"
